...
{
  turtlesim__srv__Kill_Request * msg = (turtlesim__srv__Kill_Request *)malloc(sizeof(turtlesim__srv__Kill_Request));
  if (!msg) {
    return NULL;
  }
...
turtlesim__srv__Kill_Request__Sequence__init(turtlesim__srv__Kill_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (turtlesim__srv__Kill_Request *)calloc(size, sizeof(turtlesim__srv__Kill_Request));
    if (!data) {
      return false;
    }
...
{
  turtlesim__srv__Kill_Request__Sequence * array = (turtlesim__srv__Kill_Request__Sequence *)malloc(sizeof(turtlesim__srv__Kill_Request__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  turtlesim__srv__Kill_Response * msg = (turtlesim__srv__Kill_Response *)malloc(sizeof(turtlesim__srv__Kill_Response));
  if (!msg) {
    return NULL;
  }
...
turtlesim__srv__Kill_Response__Sequence__init(turtlesim__srv__Kill_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (turtlesim__srv__Kill_Response *)calloc(size, sizeof(turtlesim__srv__Kill_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  turtlesim__srv__Kill_Response__Sequence * array = (turtlesim__srv__Kill_Response__Sequence *)malloc(sizeof(turtlesim__srv__Kill_Response__Sequence));
  if (!array) {
    return NULL;
  }
