...
class Hand(metaclass=Metaclass_Hand):
    ...
    def __init__(self, **kwargs):
        ...
        self.xpinky = kwargs.get('xpinky', float())
        self.xindex = kwargs.get('xindex', float())
    ...
    @property
    def xpinky(self):
        """Message field 'xpinky'."""
        return self._xpinky

    @xpinky.setter
    def xpinky(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'xpinky' field must be of type 'float'"
        self._xpinky = value

    @property
    def xindex(self):
        """Message field 'xindex'."""
        return self._xindex
    ...
    def xindex(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'xindex' field must be of type 'float'"
        self._xindex = value
